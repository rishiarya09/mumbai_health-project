...
if (isset($_POST['mail']) && $_POST['mail'] != '') {
  ...
  if (filter_var($_POST['mail'], FILTER_VALIDATE_EMAIL)) {
    ...
    $to = "test@gmail.com";         // Change the "To" mail id 
    $body = "";
            ...
            <div class="row">
                ...
                <div class="footer-col" id="logo_foot">
                    <div class="socials">
                        ...
                        <a href="https://instagram.com/mumbaihealthproject?utm_medium=copy_link"><i
                                class="fab fa-instagram"></i></a>
                        <a href="https://twitter.com/hargullyhealthy?s=11"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.linkedin.com/company/mumbai-health-project/"><i
